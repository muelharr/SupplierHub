...
<div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
    <div class="bg-gradient-to-r from-emerald-500 to-teal-600 rounded-xl p-6 text-white shadow-lg relative overflow-hidden">
...
<div class="bg-white rounded-xl border border-slate-100 shadow-sm overflow-hidden">
    <div class="px-6 py-4 border-b border-slate-100 bg-slate-50 flex justify-between items-center">
        <h3 class="text-base font-bold text-slate-800"><i class="ph-fill ph-clock-counter-clockwise mr-2 text-primary"></i>Riwayat Transaksi Lokal</h3>
    </div>
    <div class="overflow-x-auto">
        <table class="w-full text-left border-collapse">
            ...
            <tbody class="text-sm">
                ...
                <tr>
                    <td colspan="4" class="py-8 px-6 text-center text-slate-500">Belum ada riwayat pengeluaran.</td>
                </tr>
                <?php else: ?>
